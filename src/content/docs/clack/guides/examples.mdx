...
import WebContainer from '/src/components/WebContainer/WebContainer.astro';
...
<WebContainer name="selection-menu">
```ts twoslash
...
<WebContainer name="autocomplete-selection">
```ts twoslash
...
<WebContainer name="multi-select-groups">
```ts twoslash
...
<WebContainer name="confirmation-dialog">
```ts twoslash
...
<WebContainer name="project-setup-wizard">
```ts twoslash
...
<WebContainer name="config-setup-validation">
```ts twoslash
...
<WebContainer name="interactive-cli-tasks">
```ts twoslash
...
<WebContainer name="form-validation-complex">
```ts twoslash
import { text, select, groupMultiselect, isCancel } from '@clack/prompts';
...
<WebContainer name="path-selection">
```ts twoslash
...
<WebContainer name="progress-bar">
```ts twoslash
...
<WebContainer name="spinner-cancellation">
```ts twoslash
...
<WebContainer name="task-log-groups">
```ts twoslash
// @errors: 2345
...
<WebContainer name="abort-controller">
```ts twoslash
