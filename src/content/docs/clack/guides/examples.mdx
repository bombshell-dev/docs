...
<WebContainer name="multiselect-group">
```ts twoslash
...
With `directory: true`, only folders appear in suggestions; with an existing directory as `initialValue`, **Enter** submits that folder directly (v1.2.0).

### Autocomplete Tab and placeholder
